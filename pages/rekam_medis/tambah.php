...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $biaya_rawat_inap = ($jenis_perawatan == 'Rawat Inap') ? ($lama_rawat * 300000) : 0; // 300rb per hari
    ...
    if(empty($id_pasien) || empty($id_dokter) || empty($tanggal) || empty($keluhan) || empty($diagnosa)) {
        ...
        $query = "INSERT INTO rekam_medis (id_pasien, id_dokter, tanggal_periksa, jenis_perawatan, tanggal_masuk, tanggal_keluar, lama_rawat, keluhan, diagnosa, tindakan, id_obat, jumlah_obat, biaya_konsultasi, biaya_rawat_inap, biaya_obat, biaya_total, status_pembayaran, catatan_dokter) 
                  VALUES ($id_pasien, $id_dokter, '$tanggal', '$jenis_perawatan', " . ($tanggal_masuk == 'NULL' ? 'NULL' : "'$tanggal_masuk'") . ", " . ($tanggal_keluar == 'NULL' ? 'NULL' : "'$tanggal_keluar'") . ", $lama_rawat, '$keluhan', '$diagnosa', '$tindakan', " . ($id_obat == 'NULL' ? 'NULL' : $id_obat) . ", $jumlah_obat, $biaya_konsultasi, $biaya_rawat_inap, $biaya_obat, $biaya_total, '$status_pembayaran', '$catatan_dokter')";
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <form method="POST" action="" id="rekamForm">
            ...
            <!-- Section Rawat Inap (Hidden by default) -->
            <div id="rawatInapSection" class="hidden mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="date" name="tanggal_masuk" id="tanggalMasuk" value="<?= date('Y-m-d') ?>"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div>
                    ...
                    <textarea name="catatan_dokter" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                              placeholder="Saran dan catatan untuk pasien..."></textarea>
                </div>
            </div>
            ...
            <div class="mt-4 p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-sm" id="biayaRawatRow" style="display:none;">
                        <span>Biaya Rawat Inap (<span id="hariRawat">0</span> hari × Rp 300.000):</span>
                        <span class="font-semibold" id="biayaRawat">Rp 0</span>
                    </div>
                    <div class="flex justify-between text-sm">
