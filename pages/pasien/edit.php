    ...
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-6">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">
                <i class="fas fa-edit text-yellow-600"></i> Edit Data Pasien
            </h1>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"><?= htmlspecialchars($pasien['alamat']) ?></textarea>
                </div>
            </div>
